...
F = @(y,alp,eta,mu,nu) [(1-XI)*b - B*(1-alp)*y(1)*((1-alp)*y(2)+y(5)) - d*y(1) - (MU-mu)*y(1)*(y(4)+y(5)+y(6)) + nu*y(4) ;
                  B*(1-alp)*y(1)*((1-alp)*y(2)+y(5)) - (g+eta+d)*y(2) - (MU-mu)*y(2)*(y(4)+y(5)+y(6)) + nu*y(5);
                  (g+eta)*y(2) - d*y(3) - (MU-mu)*y(3)*(y(4)+y(5)+y(6)) + nu*y(6); 
                  XI*b - B*y(4)*((1-alp)*y(2)+y(5)) - d*y(4) + (MU-mu)*y(1)*(y(4)+y(5)+y(6)) - nu*y(4);
                  B*y(4)*((1-alp)*y(2)+y(5)) - (g+d)*y(5) + (MU-mu)*y(2)*(y(4)+y(5)+y(6)) - nu*y(5);
